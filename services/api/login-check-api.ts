...
export const LoginCheckApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        checkPost(requestParameters: LoginCheckApiCheckPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<LoginCheckPost200Response> {
            return localVarFp.checkPost(requestParameters.loginCheckPostRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class LoginCheckApi extends BaseAPI {
     ...
     */
    public checkPost(requestParameters: LoginCheckApiCheckPostRequest, options?: RawAxiosRequestConfig) {
        return LoginCheckApiFp(this.configuration).checkPost(requestParameters.loginCheckPostRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
