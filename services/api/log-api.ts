...
export const LogApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    accountsAccountIdlogsGetCollection: async (
      accountId: string,
      page?: number,
      ...
      const localVarPath = `/api/accounts/{account_id}/logs`.replace(
        `{${'account_id'}}`,
...
export const LogApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async accountsAccountIdlogsGetCollection(
      accountId: string,
      page?: number,
      options?: RawAxiosRequestConfig
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.accountsAccountIdlogsGetCollection(
          accountId,
          page,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.logsGetCollection(page, options);
      const localVarOperationServerBasePath = BASE_PATH;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const LogApiFactory = function (
  ...
  return {
     ...
     */
    accountsAccountIdlogsGetCollection(
      requestParameters: LogApiAccountsAccountIdlogsGetCollectionRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<any> {
      return localVarFp
        .accountsAccountIdlogsGetCollection(
     ...
     */
    logsGetCollection(
      requestParameters: LogApiLogsGetCollectionRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<any> {
      return localVarFp
        .logsGetCollection(requestParameters.page, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class LogApi extends BaseAPI {
   ...
   * @memberof LogApi
   */
  public accountsAccountIdlogsGetCollection(
    requestParameters: LogApiAccountsAccountIdlogsGetCollectionRequest,
    options?: RawAxiosRequestConfig
  ) {
